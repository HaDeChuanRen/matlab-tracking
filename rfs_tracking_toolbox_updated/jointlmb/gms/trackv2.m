...
for i = 1:40
    ...
    switch signalType
        ...
        case 4
            ...
            copySignal2 = createCopySig(3e3,140,0.400,'hfm','down',NFFT2);
            startp = 1500-816+512;
        case 5
            copySignal = createCopySig(3e3,140,0.400,'hfm','up',NFFT2);
            startp = 1500-816;
...
%     multibeam_mf2 = matchfilter(info.multibeam_fm.',copySignal2.');
    multibeam_show = maxshow(multibeam_mf,10,1);
%     multibeam_show2 = maxshow(multibeam_mf2,10,1);
...
%         plotList(histList)
%         hold off
    set(mainFig,'unit','centimeters','Position',[1 1 15 50])
%     figure(2)
%     pcolor(abs([multibeam_show2 multibeam_show2]));shading interp;colormap(jet);
%     set(gca,'unit','centimeters','Position',[20 1 15 50])
    getpts();
