...
model.B_birth{1}(:,:,1)= diag([ 10; 10; 2; 10 ]);                              %std of Gaussians
...
model.m_birth{2}(:,1)= [ 1; 0; 107; 0 ];                                     %mean of Gaussians
model.B_birth{2}(:,:,1)= diag([ 10; 10; 2; 10 ]);                              %std of Gaussians
...
model.B_birth{3}(:,:,1)= diag([ 0; 0; 2; 0 ]);                              %std of Gaussians
...
model.B_birth{4}(:,:,1)= diag([ 10; 10; 2; 10 ]);                              %std of Gaussians
...
model.P_D= .7;   %probability of detection in measurements
