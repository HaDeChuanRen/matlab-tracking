...
xstart(:,1)  = [ 0; 0; 0; 10 ];            tbirth(1)  = 1;     tdeath(1)  = truth.K+1;
xstart(:,2)  = [ 0; 0; 10; 10 ];       tbirth(2)  = 1;     tdeath(2)  = truth.K+1;
xstart(:,3)  = [ 0; 0; 30; 10 ];      tbirth(3)  = 1;     tdeath(3)  = truth.K+1;

xstart(:,4)  = [ 0; 0; 50; 10 ];       tbirth(4)  = 1;    tdeath(4)  = truth.K+1;
